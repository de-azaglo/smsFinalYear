<main class="home-section items-start bg-gray-200 rounded py-5 h-100">
    ...
    <div class=" p-4 bg-white w-11/12 flex flex-col items-center">
        <div class="flex justify-between items-center pb-3 border-b-2 border-red-500 w-full">
            <h1 class="text-3xl font-bold">Assignment</h1>
        ...
        <div class="container mx-auto mt-8">
            <h2 class="text-2xl font-bold">Post Assignment</h2>
            <form id="postAssignmentForm" action="/facilitator/assignment" method="POST" enctype="multipart/form-data" class="mt-4">
                <input type="text" name="title" placeholder="Assignment Title" class="block w-full p-2 border border-gray-300 rounded mb-4" required>
                <textarea name="description" placeholder="Assignment Description" class="block w-full p-2 border border-gray-300 rounded mb-4" required></textarea>
                <input type="date" name="due_date" class="block w-full p-2 border border-gray-300 rounded mb-4" required>
                ...
                <input type="file" name="file" class="block w-full p-2 border border-gray-300 rounded mb-4">
                <button type="submit" class="px-4 py-2 bg-blue-500 text-white rounded">Post Assignment</button>
            </form>
        </div>
